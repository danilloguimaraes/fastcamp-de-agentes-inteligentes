...
class User(BaseModel):
    ...
    # Exclude: indica que o campo não será incluído na serialização.
    ...
    # Aqui estão alguns modos de serialização com features do pydantic.

    # Serialização do role do usuário, utilizando Field_Serializer. 
    # When_used: indica que a serialização será feita quando o campo for usado.
    # Return: indica o valor que será retornado. 
    @field_serializer("role", when_used="json")
    @classmethod
    def serialize_role(cls, v) -> str:
        return v.name

    # Serialização do usuário, utilizando Model_Serializer.
    # A serialização é feita para o modelo de dados do usuário, e não um campo específico.
    # Mode: wrap indica que a serialização será feita para o modelo de dados do usuário.
...
def main() -> None:
    ...
    if user:
        # Serialização do usuário, utilizando Model_Dump. 
        # Print a dict with the user data. Aqui o role NÃO imprimiu o nome do enum. 
        print(
        ...
        # Serialização do usuário, utilizando Model_Dump. 
        # Print a JSON string with the user data.
        # Aqui o role imprimiu o nome do enum. como definido no field_serializer.
        print(
        ...
        # Serialização do usuário, utilizando Model_Dump. Indica que o campo 
        # role não será incluído na serialização. 
        print(
        ...
        # Serialização do usuário para um dict. Todos os valores são incluídos na serialização.
        # atenção para a senha que não foi incluída na serialização, mas sim uma representação 
        # em asteriscos.
